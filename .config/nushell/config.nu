...
$env.config = {
    ...
    keybindings: [
        ...
        {
            name: move_right_or_take_history_hint_none
            modifier: none
            keycode: right
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_one_word_right_or_take_history_hint_ctrlr
            modifier: control
            keycode: right
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_start_nonehome
            modifier: none
            keycode: home
            mode: [emacs, vi_normal, vi_insert]
        ...
        {
            name: move_to_line_start_nonechar
            modifier: none
            keycode: char__
            mode: [vi_normal]
            event: {edit: movetolinestart}
        ...
        {
            name: move_to_line_end_or_take_history_hint_none
            modifier: none
            keycode: end
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_start_ctrlhome
            modifier: control
            keycode: home
            mode: [emacs, vi_normal, vi_insert]
            event: {edit: movetolinestart}
        ...
        {
            name: delete_one_character_forward_nomod
            modifier: none
            keycode: delete
            mode: [emacs, vi_insert]
            event: {edit: delete}
        ...
        {
            name: delete_one_character_forward_ctrl_h
            modifier: control
            keycode: char_h
            mode: [emacs, vi_insert]
            event: {edit: backspace}
        ...
        {
            name: move_right_or_take_history_hint_ctrlf
            modifier: control
            keycode: char_f
            mode: emacs
            event: {
        ...
        {
            name: move_one_word_right_or_take_history_hint_altr
            modifier: alt
            keycode: right
            mode: emacs
            event: {
        ...
        {
            name: move_one_word_right_or_take_history_hint_altf
            modifier: alt
            keycode: char_f
            mode: emacs
            event: {
        ...
        {
            name: delete_one_word_backward_alt_b
            modifier: alt
            keycode: backspace
            mode: emacs
            event: {edit: backspaceword}
