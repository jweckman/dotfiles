-- USERCONFIG: Moved all opts to custom opts file. Compare that with kickstart to see differences
...
-- USERCONFIG: Load custom files that can be loaded before Lazy
	...
	-- Fuzzy Finder (files, lsp, etc)
	{
		...
		config = function()
			...
			require("telescope").setup({
				...
				--  USERCONFIG: Mostly custom telescope config
				defaults = {
					mappings = {
						i = {
							["<C-u>"] = false,
			...
			vim.keymap.set(
				...
				{ desc = "[S]earch [B]rowse Files noremap = true" }
			)
			vim.keymap.set(
				"n",
				"<leader>sg",
				"<cmd>lua require'telescope'.extensions.live_grep_args.live_grep_args()<CR>",
				{ desc = "[S]earch [G]rep Live args" }
			)
			vim.keymap.set(
				"n",
				"<leader>gb",
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>ld", require("telescope.builtin").lsp_definitions, "LSP [D]efinition")
					map("<leader>lr", require("telescope.builtin").lsp_references, "LSP [R]eferences")
					map("<leader>lgI", require("telescope.builtin").lsp_implementations, "LSP [I]mplementation")
					map("<leader>lD", require("telescope.builtin").lsp_type_definitions, "LSP Type [D]efinition")
					map("<leader>lds", require("telescope.builtin").lsp_document_symbols, "LSP [D]ocument [S]ymbols")
					map(
						"<leader>lws",
					...
					map("<leader>lf", vim.lsp.buf.format, "Lsp based format")
	...
	{ -- Autoformat
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				local disable_filetypes = { c = true, cpp = true, python = true, xml = true }
