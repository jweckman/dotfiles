...
-- USERCONFIG: Moved all opts except learder to custom opts file. Compare that with kickstart to see differences
...
--
-- USERCONFIG: No focus keycommands, using vanilla instead
--
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- USERCONFIG: Custom Telescope binds
			local builtin = require("telescope.builtin")
			vim.keymap.set("n", "<leader>sG", ":LiveGrepGitRoot<cr>", { desc = "[S]earch by [G]rep on Git Root" })
			vim.keymap.set("n", "<leader>sb", ":Telescope file_browser<CR>", { desc = "[S]earch [B]rowse Files" })
			vim.keymap.set(
				"n",
				"<leader>sg",
			...
			vim.keymap.set("n", "<leader>gd", builtin.git_status, { desc = "[G]it [D]iff" })
